...
class ProxyGeminiWithKeyring(CustomLLM):
    api_keys: list[str] = Field(default=None)
    ...
    def complete(
        ...
        url = f"https://generativelanguage.googleapis.com/v1beta/{self.model_name}:generateContent?key={api_key}"
